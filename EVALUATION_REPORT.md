...
- Emails: `redacted@example.com`, `redacted@example.com` (and
  `redacted@example.com` in a commented Cloudflare provider).
- `CostCenter = "REDACTED-CC"`, default `domain_name = "example.com"`.
- Hardcoded AWS **account ID** in the default ACM cert ARN
  (`...:000000000000:certificate/...`).
- State bucket name (`REDACTED-TFSTATE-BUCKET`).
