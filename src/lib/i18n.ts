...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    solutions: {
      ...
      cta: 'Explore VidaFire, our financial independence platform',
      items: {
        agentArchitecture: {
    ...
    products: {
      title: 'Products',
      subtitle: 'Products we build to turn complex decisions into clear, practical action.',
      learnMore: 'Explore VidaFire',
      vidafire: {
        badge: 'Financial planning platform',
        name: 'VidaFire',
        tagline: 'Turn financial independence into a plan you can act on',
        description: 'VidaFire connects your assets, debts, cash flow, monthly budget, and goals in one living view of your net worth and progress toward financial independence.',
        highlights: [
          'Track net worth, cash flow, budgets, debts, and goals',
          'Compare Lean, Regular, Fat, and Coast FIRE paths',
          'Stress-test scenarios with Monte Carlo risk analysis',
        ],
      },
    },
    vidafire: {
      badge: 'A financial independence product by Usodus Systems',
      name: 'VidaFire',
      tagline: 'See the whole financial system behind your freedom',
      intro: 'VidaFire turns the moving parts of your financial life into one actionable plan. Connect what you own, owe, earn, spend, save, and want to achieve—then see how each decision changes your path to financial independence.',
      ctaPrimary: 'Open VidaFire',
      ctaSecondary: 'Back to home',
      freeBadge: 'Built for personal, long-term financial planning',
      featuresTitle: 'Features',
      featuresSubtitle: 'From today’s budget to tomorrow’s withdrawal strategy, VidaFire keeps your plan connected.',
      features: [
        {
          title: 'Financial independence dashboard',
          description: 'See your net worth, savings rate, FIRE number, estimated timeline, and Coast FIRE progress in one place.',
        },
        {
          title: 'Assets and net worth',
          description: 'Track liquid and illiquid assets, allocation, fees, and the capital available to fund your future.',
        },
        {
          title: 'Cash flow, budgets, and debt',
          description: 'Bring recurring income and expenses, monthly plans and actuals, savings rate, and debt payoff into one system.',
        },
        {
          title: 'Goals and FIRE paths',
          description: 'Track milestones and compare Lean, Regular, Fat, and Coast FIRE paths against the life you want.',
        },
        {
          title: 'What-if planning',
          description: 'Test changes to savings, returns, retirement timing, and withdrawals before committing to a decision.',
        },
        {
          title: 'Risk-aware simulations',
          description: 'Compare scenarios, valuation-aware safe withdrawal rates, and Monte Carlo outcomes instead of relying on one optimistic forecast.',
        },
      ],
      useTitle: 'What you can do in the app',
      useSubtitle: 'VidaFire helps turn financial data into decisions you can understand and revisit.',
      useCases: [
        'Build a current net-worth baseline from liquid and illiquid assets.',
        'Model recurring income and expenses and monitor your savings rate.',
        'Plan a monthly budget, compare planned versus actual results, and follow your cash position.',
        'Organize debts and compare payoff strategies.',
        'Set financial goals and measure progress toward multiple FIRE lifestyles.',
        'Test accumulation and drawdown assumptions, including market valuation and sequence risk.',
        'Run Monte Carlo analysis to understand the probability range behind your target date.',
      ],
      disclaimerTitle: 'Planning, not financial advice',
      disclaimerBadge: 'Important',
      disclaimerBody: [
        'VidaFire is a planning and educational tool. Its projections are estimates based on the information and assumptions you provide; markets, inflation, taxes, and personal circumstances can produce materially different outcomes.',
        'VidaFire does not provide individualized investment, tax, legal, or accounting advice. Consider consulting qualified professionals before making significant financial decisions.',
      ],
      ctaTitle: 'Turn your financial independence goal into a working plan',
      ctaBody: 'Bring your complete financial picture together, test the trade-offs, and see what moves your timeline.',
    },
    clientArea: {
      title: 'Client Area',
  ...
  es: {
    ...
    solutions: {
      ...
      cta: 'Conoce VidaFire, nuestra plataforma de independencia financiera',
      items: {
        agentArchitecture: {
    ...
    products: {
      title: 'Productos',
      subtitle: 'Productos que creamos para convertir decisiones complejas en acciones claras y prácticas.',
      learnMore: 'Explorar VidaFire',
      vidafire: {
        badge: 'Plataforma de planificación financiera',
        name: 'VidaFire',
        tagline: 'Convierte la independencia financiera en un plan de acción',
        description: 'VidaFire conecta tus activos, deudas, flujo de caja, presupuesto mensual y metas en una visión viva de tu patrimonio y progreso hacia la independencia financiera.',
        highlights: [
          'Sigue patrimonio, flujo de caja, presupuestos, deudas y metas',
          'Compara las rutas Lean, Regular, Fat y Coast FIRE',
          'Evalúa escenarios con análisis de riesgo Monte Carlo',
        ],
      },
    },
    vidafire: {
      badge: 'Un producto de independencia financiera de Usodus Systems',
      name: 'VidaFire',
      tagline: 'Comprende todo el sistema financiero detrás de tu libertad',
      intro: 'VidaFire convierte las piezas de tu vida financiera en un plan accionable. Conecta lo que tienes, debes, ganas, gastas, ahorras y quieres lograr, y descubre cómo cada decisión cambia tu camino hacia la independencia financiera.',
      ctaPrimary: 'Abrir VidaFire',
      ctaSecondary: 'Volver al inicio',
      freeBadge: 'Creado para la planificación financiera personal de largo plazo',
      featuresTitle: 'Funcionalidades',
      featuresSubtitle: 'Desde el presupuesto de hoy hasta la estrategia de retiro del futuro, VidaFire mantiene tu plan conectado.',
      features: [
        {
          title: 'Panel de independencia financiera',
          description: 'Consulta patrimonio, tasa de ahorro, número FIRE, plazo estimado y progreso Coast FIRE en un solo lugar.',
        },
        {
          title: 'Activos y patrimonio',
          description: 'Sigue activos líquidos e ilíquidos, asignación, comisiones y el capital disponible para financiar tu futuro.',
        },
        {
          title: 'Flujo de caja, presupuestos y deuda',
          description: 'Integra ingresos y gastos recurrentes, planes y resultados mensuales, tasa de ahorro y pago de deudas.',
        },
        {
          title: 'Metas y rutas FIRE',
          description: 'Sigue hitos y compara las rutas Lean, Regular, Fat y Coast FIRE con la vida que quieres construir.',
        },
        {
          title: 'Planificación de escenarios',
          description: 'Prueba cambios en ahorro, rentabilidad, fecha de retiro y retiros antes de tomar una decisión.',
        },
        {
          title: 'Simulaciones conscientes del riesgo',
          description: 'Compara escenarios, tasas de retiro seguro ajustadas a valoración y resultados Monte Carlo en lugar de depender de una sola proyección optimista.',
        },
      ],
      useTitle: 'Qué puedes hacer en la app',
      useSubtitle: 'VidaFire convierte tus datos financieros en decisiones que puedes comprender y revisar.',
      useCases: [
        'Construir una base de patrimonio con activos líquidos e ilíquidos.',
        'Modelar ingresos y gastos recurrentes y seguir tu tasa de ahorro.',
        'Planificar el presupuesto mensual, comparar lo previsto con lo real y seguir tu posición de caja.',
        'Organizar deudas y comparar estrategias de pago.',
        'Definir metas financieras y medir tu progreso hacia distintos estilos FIRE.',
        'Probar supuestos de acumulación y retiro, incluida la valoración del mercado y el riesgo de secuencia.',
        'Ejecutar análisis Monte Carlo para comprender el rango de probabilidad detrás de tu fecha objetivo.',
      ],
      disclaimerTitle: 'Planificación, no asesoramiento financiero',
      disclaimerBadge: 'Importante',
      disclaimerBody: [
        'VidaFire es una herramienta educativa y de planificación. Sus proyecciones son estimaciones basadas en la información y los supuestos que proporcionas; los mercados, la inflación, los impuestos y tus circunstancias pueden producir resultados muy diferentes.',
        'VidaFire no ofrece asesoramiento personalizado de inversión, fiscal, legal ni contable. Considera consultar a profesionales cualificados antes de tomar decisiones financieras importantes.',
      ],
      ctaTitle: 'Convierte tu meta de independencia financiera en un plan activo',
      ctaBody: 'Reúne toda tu realidad financiera, prueba las alternativas y descubre qué mueve tu plazo.',
    },
    clientArea: {
  ...
  pt: {
    ...
    solutions: {
      ...
      cta: 'Conheça o VidaFire, nossa plataforma de independência financeira',
      items: {
        agentArchitecture: {
    ...
    products: {
      title: 'Produtos',
      subtitle: 'Produtos que criamos para transformar decisões complexas em ações claras e práticas.',
      learnMore: 'Explorar o VidaFire',
      vidafire: {
        badge: 'Plataforma de planejamento financeiro',
        name: 'VidaFire',
        tagline: 'Transforme independência financeira em um plano de ação',
        description: 'VidaFire conecta seus ativos, dívidas, fluxo de caixa, orçamento mensal e metas em uma visão viva do seu patrimônio e progresso rumo à independência financeira.',
        highlights: [
          'Acompanhe patrimônio, fluxo de caixa, orçamentos, dívidas e metas',
          'Compare as jornadas Lean, Regular, Fat e Coast FIRE',
          'Avalie cenários com análise de risco Monte Carlo',
        ],
      },
    },
    vidafire: {
      badge: 'Um produto de independência financeira da Usodus Systems',
      name: 'VidaFire',
      tagline: 'Enxergue todo o sistema financeiro por trás da sua liberdade',
      intro: 'VidaFire transforma as partes da sua vida financeira em um plano acionável. Conecte o que você possui, deve, ganha, gasta, poupa e deseja conquistar, e veja como cada decisão muda seu caminho para a independência financeira.',
      ctaPrimary: 'Abrir o VidaFire',
      ctaSecondary: 'Voltar ao início',
      freeBadge: 'Criado para o planejamento financeiro pessoal de longo prazo',
      featuresTitle: 'Funcionalidades',
      featuresSubtitle: 'Do orçamento de hoje à estratégia de retirada do futuro, VidaFire mantém seu plano conectado.',
      features: [
        {
          title: 'Painel de independência financeira',
          description: 'Veja patrimônio, taxa de poupança, número FIRE, prazo estimado e progresso Coast FIRE em um só lugar.',
        },
        {
          title: 'Ativos e patrimônio',
          description: 'Acompanhe ativos líquidos e ilíquidos, alocação, taxas e o capital disponível para financiar seu futuro.',
        },
        {
          title: 'Fluxo de caixa, orçamentos e dívidas',
          description: 'Integre receitas e despesas recorrentes, planos e resultados mensais, taxa de poupança e quitação de dívidas.',
        },
        {
          title: 'Metas e jornadas FIRE',
          description: 'Acompanhe marcos e compare as jornadas Lean, Regular, Fat e Coast FIRE com a vida que você quer construir.',
        },
        {
          title: 'Planejamento de cenários',
          description: 'Teste mudanças em poupança, retorno, data de aposentadoria e retiradas antes de tomar uma decisão.',
        },
        {
          title: 'Simulações conscientes do risco',
          description: 'Compare cenários, taxas de retirada segura ajustadas à avaliação e resultados Monte Carlo em vez de depender de uma única projeção otimista.',
        },
      ],
      useTitle: 'O que você pode fazer no app',
      useSubtitle: 'VidaFire transforma seus dados financeiros em decisões que você pode compreender e revisar.',
      useCases: [
        'Construa uma base de patrimônio com ativos líquidos e ilíquidos.',
        'Modele receitas e despesas recorrentes e acompanhe sua taxa de poupança.',
        'Planeje o orçamento mensal, compare o previsto com o realizado e acompanhe sua posição de caixa.',
        'Organize dívidas e compare estratégias de quitação.',
        'Defina metas financeiras e meça seu progresso rumo a diferentes estilos FIRE.',
        'Teste premissas de acumulação e retirada, incluindo avaliação de mercado e risco de sequência.',
        'Execute análises Monte Carlo para entender a faixa de probabilidade por trás da sua data-alvo.',
      ],
      disclaimerTitle: 'Planejamento, não aconselhamento financeiro',
      disclaimerBadge: 'Importante',
      disclaimerBody: [
        'VidaFire é uma ferramenta educacional e de planejamento. Suas projeções são estimativas baseadas nas informações e premissas fornecidas; mercados, inflação, impostos e circunstâncias pessoais podem produzir resultados muito diferentes.',
        'VidaFire não oferece aconselhamento personalizado de investimentos, tributos, questões jurídicas ou contábeis. Considere consultar profissionais qualificados antes de tomar decisões financeiras importantes.',
      ],
      ctaTitle: 'Transforme sua meta de independência financeira em um plano ativo',
      ctaBody: 'Reúna toda a sua realidade financeira, teste as escolhas e descubra o que muda seu prazo.',
    },
    clientArea: {
